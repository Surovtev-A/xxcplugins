...
var Modss = {
	...
	var button = "<div style='position:relative' data-subtitle='modss_v".concat(manifest.version, " (23 Balansers, 19 in VIP)' class='full-start__button selector view--modss_online'>" + ico + "<span>" + this.title + "</span></div>");
    ...
    balansers: function() {
      var balansers = {"lumex":"Lumex","videx":"ViDEX  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","filmix":"Filmix 4K","kinopub":"KinoPub 4K","fxpro":"FXpro 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","mango":"ManGo 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","alloha":"Alloha 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","hdr":"MODS's [4K, HDR]  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","iremux":"IRemux 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","eneida":"Eneida <img style=\"width:1.3em!important;height:1em!important\" src=\"data:image/png;base64,\">  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","uakino":"UAKino <img style=\"width:1.3em!important;height:1em!important\" src=\"data:image/png;base64,\"> 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","uaflix":"UaFlix <img style=\"width:1.3em!important;height:1em!important\" src=\"data:image/png;base64,\"> 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","hdrezka":"HDRezka  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","aniliberty":"AniLiberty  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kodik":"Kodik  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kinotochka":"KinoTochka  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","hdvb":"HDVB  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","collaps":"Collaps","starlight":"StarLight  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>"};
  ...
  function lumex(component, _object) {
    ...
    this.searchs = function (_object) {
      ...
      var api = API + 'lumex/sId/' + object.movie.id + '/mdss/' + (+object.movie.kinopoisk_id || +object.movie.kinopoisk_ID ? encodeURIComponent(object.movie.kinopoisk_id || object.movie.kinopoisk_ID) : 'null') + '/' + (object.movie.imdb_id ? encodeURIComponent(object.movie.imdb_id) : 'null') + '/bm9uZQ==/' + fr;
  ...
  function videx(component, _object) {
    ...
    this.searchs = function (_object) {
      ...
      var error = component.empty.bind(component);
      if (!+object.movie.kinopoisk_id && !+object.movie.kinopoisk_ID) return error();
      var src = API + 'videx/sId/mds/' + (+object.movie.kinopoisk_id || +object.movie.kinopoisk_ID ? encodeURIComponent(+object.movie.kinopoisk_id || +object.movie.kinopoisk_ID) : 'null') + '/' + (object.movie.imdb_id ? encodeURIComponent(object.movie.imdb_id) : 'null') + '/bm9uZQ==/' + fr + '?ip=' + IP + '&search=' + encodeURIComponent(select_title);
  ...
  function veoveo(component, _object) {
    ...
    this.searchs = function (_object, kinopoisk_id) {
      ...
      var error = component.empty.bind(component);
      if (!+object.movie.kinopoisk_id && !+object.movie.kinopoisk_ID) return error();
      var src = API + 'veoveo/sId/mds/' + (+object.movie.kinopoisk_id || +object.movie.kinopoisk_ID ? encodeURIComponent(+object.movie.kinopoisk_id || +object.movie.kinopoisk_ID) : 'null') + '/bm9uZQ==/' + fr + '?ip=' + IP + '&search=' + encodeURIComponent(select_title);
  ...
  function component(object) {
    ...
    var isVipBal = 9999;//(Lampa.Storage.get('pro_pub', false) ? 5 : 5);
      ...
      json.forEach(function (elem) {
        ...
        var year = ((elem.start_date || elem.year || '') + '').slice(0, 4);
      	var transl = elem.translations ? String(elem.translations).split(',').slice(0, 2) : '';
  			...
  			var episodeForms = Lampa.Lang.translate('episode_word');
  			var count_eps = elem.episodes_count ? elem.episodes_count + ' ' + _this3.num_word(elem.episodes_count, Array.isArray(episodeForms) ? episodeForms : [episodeForms, episodeForms, episodeForms]) : '';
        if (year) info.push(year);
  			if (elem.type) info.push(elem.type == 'serial' || elem.type == 'MINI_SERIES' ? (Lampa.Lang.translate('serial_word') + (count_s && ' - ' + count_s + ' ' + Lampa.Lang.translate('season_from') + ' ' + count_eps)) : 
  			           elem.type == 'TV_SHOW' ? Lampa.Lang.translate('tv_show') : 
  			           elem.type == ('movie' || 'film' || 'FILM') ? Lampa.Lang.translate('movie_word') : elem.type);
    ...
    this.getEpisodes2 = function (season, call) {
      var episodes = [];
...
// https://codeberg.org/cuschk/somafm
    ...
    function start() {
      var startPlay = function() {
        ...
        if (playPromise !== undefined) {
          ...
          console.log('Modss_Radio', 'playPromise is undefined, audio state:', _audio.readyState, 'context state:', _context ? _context.state : 'no context');
  ...
  function Radio_n(object) {
        ...
        Lampa.Select.show({
          ...
          onSelect: function onSelect(a) {
            ...
            setTimeout(function() {
              ...
              if (!currentPlayingInList && items.length > 0) {
	...
	function startPlugin() {
		...
		// Регистрация компонентов и шаблонов перенесена в конец файла, чтобы выполняться сразу при загрузке
		...
		// Lampa.Template.add('onlines_v1', ...);
		// Все шаблоны (Lampa.Template.add) перенесены в конец файла
		...
		*/
		...
		// Создание manifest и регистрация языков перенесены в конец файла
		// manifest = {...};
		// Lampa.Manifest.plugins = manifest;
		// if (!Lampa.Lang) {...}
		// Lampa.Lang.add({...});
		// Весь блок языков (от online_click_here до stream_number) перенесен в конец файла
		// Весь блок удален из startPlugin(), так как он уже зарегистрирован в конце файла
		// Весь блок языков удален (от iptv_select_playlist до stream_number)
		// iptv_select_playlist: {
		// 	ru: 'Выберите плейлист',
		// 	uk: 'Виберіть плейлист',
		// 	en: 'Choose a playlist'
		// },
		// Весь остальной блок языков удален (от iptv_add_fav до stream_number)
		// 		// Весь остальной блок языков удален (от iptv_add_fav до stream_number)
		// iptv_add_fav: {
		...
		// },
		// Остальной блок языков удален (всего ~1150 строк от iptv_later до stream_number)
		// Весь блок между строками 9519-10654 удален, так как он уже зарегистрирован в конце файла
		// iptv_later: {
		// 	ru: 'Потом',
		// 	uk: 'Потім',
		// 	en: 'Later'
		...
		// 	en: 'Now on:'
		// },
		// ... весь остальной блок языков удален (от modssfm_use_aac_title до episode_prefix) ...
...
// 	},
		...
		if (Lampa.Manifest.app_digital >= 177) {
			...
			var balansers_sync = ["lumex","videx","filmix","kinopub","hdr","fxpro","mango","alloha","filmix","kinopub","kodik","aniliberty","eneida","uakino","uaflix","hdrezka","hdvb","iremux","kinotochka","lumex","videx","zetflix","veoveo","anilibria","hdfilmtr","bazon","cdnmovies","collaps","kinobase","hydraflix","kinokrad","kinofit","seasonvar","videodb","voidboost","starlight"];
	...
	this.full = function () {
		...
		this.get(url, params, function (json) {
			...
			if(Lampa.Storage.get('pro_pub', false)) status.append('videos', owner.videos(element));
	...
	this.get = function (method) {
		...
		Filmix.network["native"](u, function (json) {
			...
			if (error && (error.status === 404 || error.statusCode === 404 || error.statusText === 'error')) {
				...
				Filmix.network["native"](Modss.proxy(owner.source) + u, function (json) {
					if (json) {
						json.url = method;
						json.usedProxy = true;
						oncomplite(json);
	...
	// Регистрация компонентов и шаблонов напрямую при загрузке, как в onlinemods.js
	try {
		...
		// Регистрация шаблонов (перенесено из startPlugin)
		...
		console.log('Modss', 'plugin', 'Components, templates, manifest registered successfully');
		
		// Вызываем startPlugin() для остальной инициализации (регистрация языков и др.)
		// Но убираем из startPlugin() регистрацию компонентов и шаблонов, чтобы не было дублирования
		setTimeout(function() {
			try {
				startPlugin();
			} catch (error) {
		...
		console.error('Modss', 'Component registration error:', error);
	}
